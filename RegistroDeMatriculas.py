...
def seleccionar_estudiante():
    """
    Esta función muestra una lista numerada de estudiantes y permite al usuario seleccionar uno por su número.
    Devuelve el índice del estudiante seleccionado.
    """
    mostrar_estudiantes()
    if len(estudiantes) == 0:
        return None
    while True:
        try:
            seleccion = int(input("Selecciona el número del estudiante: "))
...
def actualizar_estudiante():
    ...
    Muestra una lista numerada y permite al usuario seleccionar el estudiante a actualizar.
    """
    index = seleccionar_estudiante()
    if index is not None:
        ...
        print("No se ha seleccionado ningún estudiante.")

def eliminar_estudiante():
    """
    Esta función permite eliminar a un estudiante del sistema.
    Muestra una lista numerada y permite al usuario seleccionar el estudiante a eliminar.
    """
    index = seleccionar_estudiante()
    if index is not None:
        estudiante = estudiantes.pop(index)
